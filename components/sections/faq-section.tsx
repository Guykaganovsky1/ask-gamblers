...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "לפני שנרשמים לקזינו כלשהו, בדקו את הדברים הבאים: 1) האם יש רישיון חוקי (Curacao, MGA)? 2) האם יש תמיכה בעברית? 3) אילו שיטות תשלום קיימות? 4) מה תנאי הבונוסים? 5) האם יש ביקורות חיוביות משחקנים אחרים? כל הקזינו באתר שלנו עברו את כל הבדיקות האלה."
  },
  {
    question: "אילו שיטות תשלום מקובלות בקזינו אונליין?",
    answer: "רוב הקזינו המובילים מקבלים: כרטיסי אשראי בינלאומיים (ויזה, מאסטרקארד), העברות בנקאיות, ארנקים דיגיטליים (Skrill, Neteller), ומטבעות קריפטוגרפיים (Bitcoin, Ethereum, USDT). חשוב לבדוק זמני עיבוד ועמלות לפני בחירת שיטת תשלום."
  },
  {
