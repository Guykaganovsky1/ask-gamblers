...
const CASINO_ICONS: Record<string, React.ReactNode> = {
  ...
  blackjack: (
    <svg viewBox="0 0 64 64" className="w-full h-full">
      <rect x="8" y="8" width="48" height="48" rx="8" fill="none" stroke="currentColor" strokeWidth="2.5" />
      <text x="32" y="38" textAnchor="middle" fontSize="22" fontWeight="bold" fill="currentColor">A♠</text>
    </svg>
  ),
  baccarat: (
    <svg viewBox="0 0 64 64" className="w-full h-full">
  ...
  slots: (
    <svg viewBox="0 0 64 64" className="w-full h-full">
      ...
      <text x="32" y="40" textAnchor="middle" fontSize="12" fontWeight="bold" fill="currentColor">$</text>
    </svg>
  ),
  poker: (
    <svg viewBox="0 0 64 64" className="w-full h-full">
